...
public class ClassUtils {
    ...
    public static Set<String> getFileNameByPackageName2(Context context, String packageName) throws PackageManager.NameNotFoundException, IOException, InterruptedException {
    ...
    public static List<String> getClasses(Context mContext, String packageName) {
        ...
        Log.i("hong", "packageName  =" + packageName);
        try {
            ...
            for (Enumeration iter = df.entries(); iter.hasMoreElements(); ) {
                ...
                if (className.matches(regExp)) {
                    Log.i("hong", "=className  =" + className);
